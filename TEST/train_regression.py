...
model_output_path = os.path.join(
    prediction_output_dir,
    f"{target.lower()}_train_regression_xgboost_model.json",
)
metadata_output_path = os.path.join(
    prediction_output_dir,
    f"{target.lower()}_train_regression_model_metadata.json",
)
...
print(f"\n✅ 모델과 메타데이터가 저장되었습니다. ({model_output_path}, {metadata_output_path})")
